  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm tracking-widest uppercase font-medium ring-offset-background transition-all duration-500 ease-out focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-accent text-accent-foreground hover:bg-accent/90 hover:-translate-y-0.5",
        "gold-outline": "border border-accent text-accent hover:bg-accent hover:text-accent-foreground",
        hero: "bg-primary text-primary-foreground hover:bg-primary/95 hover:-translate-y-0.5 text-xs sm:text-sm",
        ...
        cta: "bg-accent text-accent-foreground hover:bg-accent/95 hover:-translate-y-0.5 text-sm",
        success: "bg-emerald-600 text-white hover:bg-emerald-700",
        "oto-accept": "bg-accent text-accent-foreground hover:bg-accent/90 shadow-sm text-base tracking-widest py-4",
